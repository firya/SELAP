...
gulp.task('scripts', function() {
	gulp.src([path.js.src+'jquery-1.11.2.js', path.js.src+path.js.filter, path.js.src+'myscripts.js'])
...
gulp.task('styles', function() {
	...
	gulp.src([path.css.src+'normalize.css', path.css.src+'common.css', path.css.src+path.css.filter, path.css.src+'style.css'])
...
gulp.task('watch', function () {
	gulp.watch(path.js.src+'**/*.js', ['scripts', 'bs:reload']);
	gulp.watch(path.css.src+'**/*.css', ['styles', 'bs:reload']);
	gulp.watch(['**/*.php', '**/*.html'], ['bs:reload']);
})

gulp.task('default', ['bs', 'scripts', 'styles', 'watch']);