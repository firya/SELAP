        ...
        createDateTimePicker = function(input) {
            ...
            datetimepicker.setOptions = function(_options) {
                ...
                if (_options.highlightedDates && $.isArray(_options.highlightedDates) && _options.highlightedDates.length) {
                    $.each(_options.highlightedDates, function(index, value) {
                        var splitData = $.map(value.split(","), $.trim), exDesc, hDate = new HighlightedDate(Date.parseDate(splitData[0], options.formatDate), splitData[1], splitData[2]), keyDate = hDate.date.dateFormat(options.formatDate);
                ...
                if (_options.highlightedPeriods && $.isArray(_options.highlightedPeriods) && _options.highlightedPeriods.length) {
                    ...
                    $.each(_options.highlightedPeriods, function(index, value) {
                        var splitData = $.map(value.split(","), $.trim), dateTest = Date.parseDate(splitData[0], options.formatDate), dateEnd = Date.parseDate(splitData[1], options.formatDate), desc = splitData[2], hDate, keyDate, exDesc, style = splitData[3];
            ...
            datetimepicker.on("xchange.xdsoft", function(event) {
                ...
                xchangeTimer = setTimeout(function() {
                    ...
                    var table = "", start = new Date(_xdsoft_datetime.currentTime.getFullYear(), _xdsoft_datetime.currentTime.getMonth(), 1, 12, 0, 0), i = 0, j, today = _xdsoft_datetime.now(), maxDate = false, minDate = false, hDate, d, y, m, w, classes = [], customDateSettings, newRow = true, time = "", h = "", line_time, description;
